...
public class TestMatrix {
	...
	public void testAddElements1() //Negative test case
	{
		...
		Matrix matrixObj = new Matrix(noOfRows,noOfCols);
		int value = 4;
		boolean isCorrect=matrixObj.addElements(-1, 0, value);
		assertEquals(false, isCorrect);
	
	}
	@Test	
	public void testAddElements2() //Negative test case
	{
		int noOfRows = 3, noOfCols = 4;
		Matrix matrixObj = new Matrix(noOfRows, noOfCols);
		int value = 4;
		boolean isCorrect=matrixObj.addElements(0, 4, value);
		assertEquals(false, isCorrect);
	...
	{	
		...
		Matrix matrixObj = new Matrix(noOfRows,noOfCols);
		matrixObj.addElements(0, 0, 1);
		matrixObj.addElements(0, 1, 2);
		matrixObj.addElements(1, 0, 3);
		matrixObj.addElements(1, 1, 4);
		Matrix transposeMatrix= matrixObj.transpose();

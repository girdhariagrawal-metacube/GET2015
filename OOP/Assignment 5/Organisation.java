/**
 * @author Girdhari
 * Similar to Person class this class extends Entity class and contains information related to Organisation
 */
...
public class Organisation extends Entity {
	...
	public Organisation(int id, String emailId, String name, String phoneNo,
			String numberOfCoursesOffered, String numberOfPlacements) {
	...
	public boolean equals(Object object) {
		...
		if (this.numberOfCoursesOffered == organisation.numberOfCoursesOffered
				&& this.numberOfPlacements == organisation.numberOfPlacements)
			return true;
		return false;
	}
}

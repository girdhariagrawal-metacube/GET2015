/**
 * @author Girdhari
 * Graph class contains all the information of nodes and vertices
 */
...
public class Graph {
	...
	public void printGraph()
	{
		...
		for (int vertexNo = 0 ; vertexNo < noOfVertices ; vertexNo++)
	    {
	        ...
	        System.out.print("Node no =>" +node.getData()+"Has Adjacent");
	        
	        for(int adjacent = 0 ; adjacent < node.getEdgeList().size() ; adjacent++)
	        {
	        	  System.out.print("=>"  +node.getEdgeList().get(adjacent).getNextNode().getData());
	        }
	        System.out.println();
	    }

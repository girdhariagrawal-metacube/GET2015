...
public class FahrenheitToCelsiusServiceLocator extends org.apache.axis.client.Service implements com.lab.temprature.FahrenheitToCelsiusService {
    ...
    private java.lang.String FahrenheitToCelsius_address = "http://localhost:8080/Webservices-Assignment-1/services/FahrenheitToCelsius";
    ...
    public com.lab.temprature.FahrenheitToCelsius getFahrenheitToCelsius() throws javax.xml.rpc.ServiceException {
    ...
    public com.lab.temprature.FahrenheitToCelsius getFahrenheitToCelsius(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.lab.temprature.FahrenheitToCelsiusSoapBindingStub _stub = new com.lab.temprature.FahrenheitToCelsiusSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.lab.temprature.FahrenheitToCelsius.class.isAssignableFrom(serviceEndpointInterface)) {
                com.lab.temprature.FahrenheitToCelsiusSoapBindingStub _stub = new com.lab.temprature.FahrenheitToCelsiusSoapBindingStub(new java.net.URL(FahrenheitToCelsius_address), this);
                _stub.setPortName(getFahrenheitToCelsiusWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://temprature.lab.com", "FahrenheitToCelsiusService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://temprature.lab.com", "FahrenheitToCelsius"));
        }
